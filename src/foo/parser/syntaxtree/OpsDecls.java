...
import foo.parser.syntaxtree.LabelList;
...
public class OpsDecls implements Node {
   ...
   public foo.parser.syntaxtree.LabelList f1;

   public OpsDecls(foo.parser.syntaxtree.NodeToken n0, foo.parser.syntaxtree.LabelList n1) {
      f0 = n0;
      f1 = n1;
   }
